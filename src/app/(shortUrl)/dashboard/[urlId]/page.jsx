              ...
              <article className="mt-5 grid grid-cols-4 grid-rows-5 gap-4 ">
                ...
                <div className="row-span-2 flex flex-col justify-between items-start rounded-md p-4 bg-black/10 dark:bg-white/10">
                  <div className="flex justify-between items-center w-full">
                    <p className="text-black/80 dark:text-white/80">Views totales</p>
                    <p><EyeShow /></p>
                  </div>
                ...
                <div className="row-span-5 flex flex-col justify-between items-start rounded-md p-4 bg-black/10 dark:bg-white/10"></div>
