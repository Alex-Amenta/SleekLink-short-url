  ...
  return (
    <main className="min-h-screen px-10 lg:px-48">
      ...
      <div className="mt-10 flex justify-start items-center gap-4 flex-wrap">
        <input className="p-2 border border-l-8 bg-white border-black rounded max-w-[600px] w-full focus-visible:border-green-400 shadow-lg" type="text" placeholder="Ejemplo: https://tu-url.com/" required/>
