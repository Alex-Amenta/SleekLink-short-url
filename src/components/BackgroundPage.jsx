const BackgroundPage = () => {
  return (
    <>
      ...
      <div className="absolute top-0 left-0 -z-10 h-screen w-screen bg-[radial-gradient(100%_50%_at_50%_0%,rgba(0,255,10,38%)_0,rgba(0,163,255,0)_70%,rgba(0,163,255,0)_100%)]"></div>
    </>
  );
};
