...
const Hero = () => {
  ...
  return (
    <div>
      <h1 className={`sm:hidden text-6xl text-center text-pretty font-bold mt-16 mb-6 bg-gradient-to-r ${fromColor} to-green-600 inline-block text-transparent bg-clip-text`}>Acorta y comparte links facilmente</h1>
      <h1
      ...
      <p className="text-base w-full text-center lg:w-[70%] lg:mx-auto text-black/65 dark:text-white/65">
